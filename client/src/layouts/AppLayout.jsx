      ...
      <div className="flex min-h-[calc(100vh-64px)]">
        ...
        <aside className="hidden w-64 p-6 shadow-xl bg-white/80 backdrop-blur-xl md:block">
          ...
          <ul className="mb-8 space-y-3 text-textMain">
            ...
            <li onClick={() => navigate("/resources")} className="cursor-pointer hover:text-primary">
              Resource Hub
            </li>
            <li onClick={() => navigate("/events")} className="cursor-pointer hover:text-primary">
              Event Feed
            </li>
            ...
            <li onClick={() => navigate("/saved")} className="cursor-pointer hover:text-primary">
              Saved Posts
            </li>
          </ul>
        ...
        {/* MAIN CONTENT */}
        <main className="flex-1 px-6 py-10 pt-6">
